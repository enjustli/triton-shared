...
// CHECK-DAG:       [[VAR_1_:%.+]] = ptr.to_ptr [[VAR_cast_]] : memref<1xf32> to <#tptr.default_memory_space>
...
// CHECK:             [[VAR_8_:%.+]] = ptr.ptr_add [[VAR_1_]] [[VAR_7_]] : <#tptr.default_memory_space>, i32 to <#tptr.default_memory_space>
// CHECK:             scf.yield [[VAR_8_]] : !ptr.ptr<#tptr.default_memory_space>
// CHECK:           } else {
// CHECK:             [[VAR_6_1_:%.+]] = arith.muli [[PARAM_2_]], [[VAR_0_]] : i32
// CHECK:             [[VAR_7_1_:%.+]] = ptr.ptr_add [[VAR_1_]] [[VAR_6_1_]] : <#tptr.default_memory_space>, i32 to <#tptr.default_memory_space>
