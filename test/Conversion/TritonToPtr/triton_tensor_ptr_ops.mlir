...
// CHECK-DAG:       [[VAR_0_:%.+]] = ptr.type_offset i64  : i32
...
// CHECK:             [[VAR_23_1_:%.+]] = ptr.ptr_add [[IN_1_]] [[VAR_22_1_]] : <#tptr.default_memory_space>, i32 to <#tptr.default_memory_space>
...
// CHECK:             [[VAR_22_2_:%.+]] = ptr.from_ptr [[IN_4_]] : <#tptr.default_memory_space> to memref<1xi32>
...
// CHECK:             [[VAR_22_5_:%.+]] = ptr.from_ptr [[IN_10_]] : <#tptr.default_memory_space> to memref<1xi32>
...
// CHECK:             [[VAR_23_2_:%.+]] = ptr.ptr_add [[IN_12_]] [[VAR_22_6_]] : <#tptr.default_memory_space>, i32 to <#tptr.default_memory_space>
...
// CHECK:             [[VAR_23_3_:%.+]] = ptr.ptr_add [[IN_22_]] [[VAR_22_10_]] : <#tptr.default_memory_space>, i32 to <#tptr.default_memory_space>
...
// CHECK:             [[VAR_22_12_:%.+]] = ptr.from_ptr [[IN_27_]] : <#tptr.default_memory_space> to memref<1xi32>
