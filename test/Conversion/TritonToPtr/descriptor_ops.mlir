...
module {
  ...
  func.func @descriptor_reduce(%dst: memref<*xi32>, %src: tensor<2x4xi32>,
                               %m: i32, %n: i32) {
    %dst_ptr = builtin.unrealized_conversion_cast %dst : memref<*xi32> to !tt.ptr<i32>
    %c0_i32 = arith.constant 0 : i32
    %c4_i64 = arith.constant 4 : i64
  ...
  func.func @descriptor_gather(%src: memref<*xi32>, %x_offsets: tensor<8xi32>,
    ...
    return %val : tensor<8x8xi32>
  }

  func.func @descriptor_scatter(%dst: memref<*xi32>, %x_offsets: tensor<8xi32>,
...
// CHECK-LABEL: func.func @descriptor_reduce(
...
// CHECK-SAME: in writable %[[SUBVIEW]]
// CHECK-NOT: tt.descriptor_reduce
// CHECK: return

// CHECK-LABEL: func.func @descriptor_gather(
...
// CHECK-LABEL: func.func @descriptor_scatter(
